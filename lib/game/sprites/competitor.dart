...
abstract class Competitor<T> extends SpriteGroupComponent<T>
    with HasGameRef<RaceGame>, CollisionCallbacks {
...
class EnemyPlatform extends Competitor<EnemyPlatformState> {
  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    if(other is PlayerTwo || other is Player ){
  ...
  Future<void>? onLoad() async {
    ...
    sprites = <EnemyPlatformState, Sprite>{
      ...
      // await gameRef.('game/$enemySprite.png'),
    };
  ...
  void resetB() {
    position = Vector2(x, (gameRef.size.y + 386));
  }
}
