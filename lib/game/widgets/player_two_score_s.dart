...
class GameScoreDisplayP2 extends StatelessWidget {
  const GameScoreDisplayP2({super.key, required this.game, this.isLight = false});
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: (game as RaceGame).gameManager.score2,
